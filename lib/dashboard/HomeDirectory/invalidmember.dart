...
//
// class InInvalid_Member extends StatefulWidget {
//   @override
//   _InInvalid_MemberState createState() => _InInvalid_MemberState();
// }
//
// class _InInvalid_MemberState extends State<InInvalid_Member>with TickerProviderStateMixin {
...
//
//   List<Data> teamList = [];
//   Future<void> invalidUserData() async {
//     print("🤣🤣🤣");
//     final prefs = await SharedPreferences.getInstance();
//     final userid = prefs.getString("userId");
//     print(userid);
//     final response =
//         await http.get(Uri.parse('${ApiConst.teamLevel}$userid&type=1'));
//     final data = json.decode(response.body);
//     print('${ApiConst.teamLevel}$userid&type=1');
...
class _Invalid_MemberState extends State<Invalid_Member> with TickerProviderStateMixin {
          ...
          Expanded(
            child: TabBarView(
              ...
              children: teamList.map((levelData) {
                ...
                ):Center(child: Text("No Data Found",style: gridText,));
              }).toList(),
            ),
          ),
        ],
  ...
  Future<void> validUserData() async {
    ...
    final response = await http.get(Uri.parse('${ApiConst.teamLevel}$userid&type=1'));
    final data = json.decode(response.body);
