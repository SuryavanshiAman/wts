...
import 'package:wts/dashboard/ProductDirectory/product_fixed_product_view.dart';
...
class _TabFourState extends State<TabFour> {
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              constantbutton(onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>TabFourProductView(view:snapshot.data![index])));
                              }, text: 'Join Project',)
  ...
  Future<List<ProductAdaniController>> qwe()  async {
    ...
    print("amanuserid:$userid");
    final response = await http.get(Uri.parse('${ApiConst.fixedAmount}$userid'));
