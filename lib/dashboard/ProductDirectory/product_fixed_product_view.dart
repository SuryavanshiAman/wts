...
class TabFourProductView extends StatefulWidget {
  final ProductAdaniController view;
  const TabFourProductView({required this.view});

  @override
  State<TabFourProductView> createState() => _TabFourProductViewState();
}

class _TabFourProductViewState extends State<TabFourProductView> {
  @override
  ...
  Productpurches() async {
    ...
    final response = await http.get(Uri.parse(
        "${ApiConst.getFixedProduct}$userid&type=4&amount=${widget.view.price}&productid=${widget.view.id}"));
    //     https://admin.100xbull.com/Api/getfixedproduct?userid=68&type=4&amount=10&productid=102
